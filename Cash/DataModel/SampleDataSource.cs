...
namespace Cash.Data
{
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            get { return this._accountTags.Types; }
        }
        ...
        public static IEnumerable<AccountTag> GetAccountTags()
        {
            return _sampleDataSource.AccountTags;
        }

        public static IEnumerable<Currency> GetCurrencies()
        {
            return _sampleDataSource._currencies;
        }
